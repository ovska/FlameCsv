...
{
    protected override Func<object[], IMaterializer<T, TResult>> GetMaterializerInit<TResult>(CsvBindingCollection<TResult> bc)
    {
    ...
    protected override Delegate GetValueFactory<TResult>(CsvBindingCollection<TResult> bc)
    {
