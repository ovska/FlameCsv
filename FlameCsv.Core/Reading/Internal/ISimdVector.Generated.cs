...
/// <summary>
/// Interface for extracting the most significant bits from a vector.
/// Count of the vector is the number of bits in <typeparamref name="TMask"/>.
/// </summary>
[System.CodeDom.Compiler.GeneratedCode(Messages.T4Template, null)]
...
internal readonly struct Vec64Char : ISimdVector<char, Vec64Char>, IMoveMask<byte>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vec64Char Create(char value)
    {
        Debug.Assert(value < 128);
        return Vector64.Create(unchecked((byte)value));
    }
...
[System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
[System.CodeDom.Compiler.GeneratedCode(Messages.T4Template, null)]
internal readonly struct Vec256Char : ISimdVector<char, Vec256Char>, IMoveMask<uint>
{
...
internal readonly struct Vec64Byte : ISimdVector<byte, Vec64Byte>, IMoveMask<byte>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vec64Byte Create(byte value)
    {
        Debug.Assert(value < 128);
...
[System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
[System.CodeDom.Compiler.GeneratedCode(Messages.T4Template, null)]
internal readonly struct Vec256Byte : ISimdVector<byte, Vec256Byte>, IMoveMask<uint>
{
    private readonly Vector256<byte> _value;
