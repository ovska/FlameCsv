...
public static class CsvBufferReader
{
    ...
    {
        return new ConstantPipeReader<char>(csv);
    }
    ...
    {
        return new ConstantPipeReader<T>(csv);
    }
    ...
    {
        return new ConstantPipeReader<byte>(csv);
    }
    ...
    public static ICsvBufferReader<T> Create<T>(
        ...
        where T : unmanaged
    {
        if (csv.IsSingleSegment) return new ConstantPipeReader<T>(csv.First);
