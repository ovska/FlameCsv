...
public class CsvTextReaderOptions : CsvReaderOptions<char>
{
    /// <summary>
    /// String pool to use by default for all strings. If set, <see cref="Parsers.Text.PoolingStringTextParser"/> is used
    /// as the default string parser.<br/>
    /// Default is <see langword="null"/>, which results in no pooling and <see cref="Parsers.Text.StringTextParser"/> as the default.
    /// </summary>
    /// <remarks>
    /// Pooling reduces throughput, but can have profound impact on allocations if the data has a lot of repeating strings.
    /// </remarks>
