    ...
    where T : unmanaged, IEquatable<T>
{
    ...
    /// <summary>
    /// Attempts to read until a non-string <see cref="CsvParserOptions{T}.NewLine"/> is found.
    /// </summary>
    ...
    /// <param name="quoteCount">Count of string delimiters in <paramref name="line"/>, used when
    /// parsing the columns later on. Should be ignored if the method returns <see langword="false"/>.</param>
    /// <returns>
