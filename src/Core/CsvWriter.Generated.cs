...
static partial class CsvWriter
{
        ...
        CsvIOOptions ioOptions = default)
    {
        ...
        ioOptions = ioOptions.ForFileIO();
        ICsvBufferWriter<char> fileWriter = GetFileBufferWriter(path, encoding, isAsync: false, in ioOptions);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        ioOptions = ioOptions.ForFileIO();
        ICsvBufferWriter<char> fileWriter = GetFileBufferWriter(path, encoding, isAsync: true, in ioOptions);
