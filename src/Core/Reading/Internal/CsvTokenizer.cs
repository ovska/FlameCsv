    ...
    where T : unmanaged, IBinaryInteger<T>
{
    ...
    /// <summary>
    /// Reads fields from the data into <paramref name="recordBuffer"/>.
    /// </summary>
...
{
    /// <summary>
    /// Reads fields from the data into <paramref name="recordBuffer"/> until the end of the data is reached.
    /// </summary>
    /// <param name="recordBuffer">Buffer to parse the records to</param>
    /// <param name="data">Data to read from</param>
